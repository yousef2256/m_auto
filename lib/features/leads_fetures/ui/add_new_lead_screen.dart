    ...
    return BlocConsumer<LeadsCubit, LeadsState>(
      ...
      builder: (context, state) {
        return Scaffold(
          ...
          body: state is GetCarBrandsAndModelsLoading
              ? const Center(
                  child: CircularProgressIndicator(),
                )
              : state is GetCarBrandsAndModelsSuccess
                  ? Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              CustomeDropdown(
                                ...
                                onChanged: (value) {
                                  if (value != null) {
                                    context
                                        .read<LeadsCubit>()
                                        .updateSelectedBrand(int.parse(value));
                                  }
                                },
                              ),
                              ...
                              CustomeTextFeald(
                                ...
                                controller:
                                    context.read<LeadsCubit>().notesController,
                              ),
